...
public class ComicTextController : MonoBehaviour {
    ...
    void state_comic1()
    {
        gameText.text = "Rocket: Make sure to look both ways before crossing the street!I love going to Phoenix Comics." +
                        ...
                        "" + PlayerPrefs.GetString("Name") + ": Pick it up.\n (Press the Up Arrow to pick it up)\n\n" +
                        "" + PlayerPrefs.GetString("Name") + ": Ignore it, go inside the store, and forget about it.\n (Press I to ignore)\n\n" +
                        "" + PlayerPrefs.GetString("Name") + ": Notice where it is, go inside the store, and tell an adult.\n (Press the S key to go into the Store)";
