...
public class BusTextController : MonoBehaviour {
    ...
    void state_bus()
    {
        gameText.text = "Rocket: We made it to the 49! There are lots of people standing here at this bus stop, I bet they’re all waiting for the bus too." +
                        ...
                        "Player: As the bus arrives, I should Wait where I am standing and move in an orderly fashion to the bus," +
    ...
    void state_tryAgain()
    {
        gameText.text = "Rocket:  That’s not quite right! Etiquette, or the way we are considerate to others in public," +
    ...
    void state_bus2()
    {
        gameText.text = "Rocket:  That’s right! Etiquette, or the way we are considerate to others in public," +
